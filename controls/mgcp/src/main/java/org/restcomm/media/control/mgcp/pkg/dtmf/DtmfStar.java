 ...
 * @author kulikov
 */
public class DtmfStar extends AbstractDtmfEvent {
    private final static Event dtmf_star = new Event(new Text("*"));

    public DtmfStar(String name) {
        super(name);
    }
