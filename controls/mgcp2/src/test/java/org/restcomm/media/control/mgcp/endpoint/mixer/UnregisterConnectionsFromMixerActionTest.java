...
public class UnregisterConnectionsFromMixerActionTest {
    ...
    public void testUnregisterConnectionsFromMixer() {
        ...
        // then
        verify(mixer, times(unregistered.length)).addComponent(any(AudioComponent.class));
        verify(oobMixer, times(unregistered.length)).addComponent(any(OOBComponent.class));
    }
