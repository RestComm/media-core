 ...
 */
public class UnregisterMediaGroupMixerActionTest {

    @Test
    public void testUnregisterMediaGroupInMixer() {
        // given
        ...
        when(mediaGroup.getAudioComponent()).thenReturn(component);
        when(mediaGroup.getOobComponent()).thenReturn(oobComponent);
        ...
        // then
        verify(mixer).release(component);
        verify(oobMixer).release(oobComponent);
    }
