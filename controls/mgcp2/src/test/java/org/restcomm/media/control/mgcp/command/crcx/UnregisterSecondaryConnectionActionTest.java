 ...
 *
 */
public class UnregisterSecondaryConnectionActionTest {

    @Test
    public void testUnregisterSecondaryConnection() {
        // given
        ...
        context.setSecondaryEndpoint(endpoint);
    ...
    @Test
    public void testUnregisterSecondaryConnectionFailure() {
        // given
        final MgcpConnectionProvider connectionProvider = mock(MgcpConnectionProvider.class);
        final MgcpEndpointManager endpointManager = mock(MgcpEndpointManager.class);
        final int transactionId = 6;
