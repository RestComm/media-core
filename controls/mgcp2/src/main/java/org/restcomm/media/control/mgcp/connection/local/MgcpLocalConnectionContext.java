...
public class MgcpLocalConnectionContext extends MgcpConnectionContext {
    ...
    public MgcpLocalConnectionContext(int identifier, int callIdentifier, int halfOpenTimeout, int timeout) {
        super(identifier, callIdentifier, halfOpenTimeout, timeout);
    }

    public MgcpLocalConnectionContext(int identifier, int callIdentifier, int timeout) {
        super(identifier, callIdentifier, timeout);
    }

    public MgcpLocalConnectionContext(int identifier, int callIdentifier) {
    ...
    public void setAudioChannel(LocalDataChannel audioChannel) {
