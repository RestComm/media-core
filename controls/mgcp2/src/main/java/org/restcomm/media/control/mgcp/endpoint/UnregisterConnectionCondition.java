 ...
 *
 */
public class UnregisterConnectionCondition extends AnonymousCondition<MgcpEndpointTransitionContext> {

    static final UnregisterConnectionCondition INSTANCE = new UnregisterConnectionCondition();

    UnregisterConnectionCondition() {
        super();
    }
