 ...
 *
 */
public class OpenSecondaryConnectionAction extends OpenConnectionAction {

    static final OpenSecondaryConnectionAction INSTANCE = new OpenSecondaryConnectionAction();

    public OpenSecondaryConnectionAction() {
        super();
    }
