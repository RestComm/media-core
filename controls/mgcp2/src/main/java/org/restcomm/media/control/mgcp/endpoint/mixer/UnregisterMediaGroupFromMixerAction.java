...
/**
 * Unregisters a media group from the in-band and out-of-band mixers of the endpoint.
 * 
 * <p>
 * Input parameters:
 * <ul>
 ...
 *
 */
public class UnregisterMediaGroupFromMixerAction
    ...
    private static final Logger log = Logger.getLogger(UnregisterMediaGroupFromMixerAction.class);
    
    static final MgcpEndpointAction INSTANCE = new UnregisterMediaGroupFromMixerAction();
    ...
    public void execute(MgcpEndpointState from, MgcpEndpointState to, MgcpEndpointEvent event, MgcpEndpointTransitionContext context, MgcpEndpointFsm stateMachine) {
        ...
        MediaGroupImpl mediaGroup = (MediaGroupImpl) globalContext.getMediaGroup();

        // Register connection to in-band mixer
        AudioComponent component = mediaGroup.getAudioComponent();
        ...
        if (log.isTraceEnabled()) {
            ...
            log.trace("Endpoint " + endpointId + " unregistered media group component " + componentId + " from the in-band mixer.");
        }

        // Register connection to out-of-band mixer
        OOBComponent oobComponent = mediaGroup.getOobComponent();
        ...
        if (log.isTraceEnabled()) {
            ...
            log.trace("Endpoint " + endpointId + " unregistered media group component " + componentId + " from the out-of-band mixer.");
        }
    }
