 ...
 *
 */
class NoRequestedSignalsCondition extends NotificationCenterCondition {

    static final NoRequestedSignalsCondition INSTANCE = new NoRequestedSignalsCondition();

    NoRequestedSignalsCondition() {
        super();
    }
