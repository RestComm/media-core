 ...
 *
 */
class SecondaryConnectionRegisteredCondition extends AnonymousCondition<CreateConnectionContext> implements CreateConnectionCondition {

    static final SecondaryConnectionRegisteredCondition INSTANCE = new SecondaryConnectionRegisteredCondition();
    
    SecondaryConnectionRegisteredCondition() {
        super();
    }
