 ...
 *
 */
class StopExecutingAction extends ModifyConnectionAction {

    static final StopExecutingAction INSTANCE = new StopExecutingAction();
    ...
    public void execute(ModifyConnectionState from, ModifyConnectionState to, ModifyConnectionEvent event, ModifyConnectionContext context, ModifyConnectionFsm stateMachine) {
        stateMachine.fire(ModifyConnectionEvent.EXECUTED, context);
    }
