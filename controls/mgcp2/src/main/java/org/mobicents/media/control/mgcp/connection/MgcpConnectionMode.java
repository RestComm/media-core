 ...
 *
 */
public enum MgcpConnectionMode {
    ...
    private MgcpConnectionMode(String description) {
        this.description = description;
    }
    
    public static final MgcpConnectionMode fromDescription(String description) {
        if(description != null && !description.isEmpty()) {
            for (MgcpConnectionMode mode : values()) {
