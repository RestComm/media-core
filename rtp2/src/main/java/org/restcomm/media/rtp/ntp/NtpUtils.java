...
package org.restcomm.media.rtp.ntp;
...
public class NtpUtils {
     ...
     * 
     * @param ntp The most significant word of the NTP time stamp
     * @return The middle 32 bits out of 64 in the NTP timestamp received as part of the most recent RTCP sender report (SR).
     */
