 ...
 *
 */
public class RtpSessionCloseListener extends AbstractRtpSessionFsmListener {
    
    private final FutureCallback<Void> callback;

    public RtpSessionCloseListener(RtpSessionFsm fsm, FutureCallback<Void> callback) {
        super(fsm);
