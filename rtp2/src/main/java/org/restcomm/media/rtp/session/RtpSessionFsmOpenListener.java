 ...
 *
 */
public class RtpSessionFsmOpenListener {

    private static final Logger log = Logger.getLogger(RtpSessionFsmOpenListener.class);

    private final FutureCallback<Void> callback;

    public RtpSessionFsmOpenListener(FutureCallback<Void> callback) {
    ...
    public void transitionDeclined(RtpSessionState from, RtpSessionEvent event, RtpSessionTransactionContext context) {
        if (context != null) {
            FutureCallback<Void> originator = context.getCallback();
            if (this.callback == originator) {
                RtpSessionException exception = new RtpSessionException("Invalid action " + event);
    ...
    public void onActionExecException(Action<?, ?, ?, ?> action, TransitionException e) {
        ...
        log.info("onActionExecException " + action.toString());
    }
