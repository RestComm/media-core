*RestComm Media Server* (RMS) is a Java real-time Media Server that offers streaming, conferencing, recording, playback, IVR, Text-to-speech and other rich media features.
