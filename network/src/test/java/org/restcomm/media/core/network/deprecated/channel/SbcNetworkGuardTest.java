...
package org.restcomm.media.core.network.deprecated.channel;
...
import org.restcomm.media.core.network.deprecated.channel.NetworkChannel;
import org.restcomm.media.core.network.deprecated.channel.NetworkGuard;
import org.restcomm.media.core.network.deprecated.channel.SbcNetworkGuard;
...
public class SbcNetworkGuardTest {
    ...
    @Test
    public void testSecureSourceWhileChannelDisconnected() {
        // given
        ...
        Mockito.when(channel.getRemoteAddress()).thenReturn(null);
