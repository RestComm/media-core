...
import org.restcomm.media.server.bootstrap.ioc.provider.mgcp.DynamicMgcpPackageManagerProvider;
import org.restcomm.media.server.bootstrap.ioc.provider.mgcp.GlobalMgcpEventProviderProvider;
import org.restcomm.media.server.bootstrap.ioc.provider.mgcp.GlobalMgcpTransactionManagerProvider;
import org.restcomm.media.server.bootstrap.ioc.provider.mgcp.MediaGroupProviderProvider;
import org.restcomm.media.server.bootstrap.ioc.provider.mgcp.Mgcp2ControllerProvider;
import org.restcomm.media.server.bootstrap.ioc.provider.mgcp.MgcpChannelProvider;
import org.restcomm.media.server.bootstrap.ioc.provider.mgcp.MgcpCommandProviderProvider;
import org.restcomm.media.server.bootstrap.ioc.provider.mgcp.MgcpConnectionProviderProvider;
import org.restcomm.media.server.bootstrap.ioc.provider.mgcp.MgcpEndpointInstallerProvider;
import org.restcomm.media.server.bootstrap.ioc.provider.mgcp.MgcpEndpointManagerProvider;
import org.restcomm.media.server.bootstrap.ioc.provider.mgcp.MgcpSignalProviderProvider;
import org.restcomm.media.server.bootstrap.ioc.provider.mgcp.MgcpTransactionNumberspaceProvider;
