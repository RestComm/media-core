...
public class Mgcp2ControllerProvider implements Provider<MgcpController> {
    ...
    @Inject
    public Mgcp2ControllerProvider(MediaServerConfiguration config, MgcpNettyChannel channel, MgcpTransactionManager transactions, MgcpEndpointManager endpoints, MgcpCommandProvider commands) {
