...
import org.restcomm.media.bootstrap.ioc.provider.MgcpPacketHandlerProvider;
...
import org.restcomm.media.bootstrap.ioc.provider.mgcp.MgcpConnectionProviderProvider;
...
import org.restcomm.media.bootstrap.ioc.provider.mgcp.MgcpNettyChannelProvider;
...
import org.restcomm.media.bootstrap.ioc.provider.mgcp.SubMgcpTransactionManagerProviderProvider;
...
public class MgcpModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        bind(MgcpNettyChannel.class).toProvider(MgcpNettyChannelProvider.class).in(Singleton.class);
