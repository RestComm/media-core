...
public class RtpChannel extends MultiplexedChannel implements DtlsListener {
	...
	protected RtpChannel(int channelId, int jitterBufferSize, RtpStatistics statistics, RtpClock clock, RtpClock oobClock, PriorityQueueScheduler scheduler, UdpManager udpManager) {
