 ...
 * @author amit bhayani
 */
public class AUSignalFactory implements GeneratorFactory {
    ...
    private class AnnSignal extends SignalGenerator {
        ...
        public void start(Request request) {
            ...
            if (generator != null) {
                try {
                   // generator.setURL(options.getUri());
                    
                    //apply offset
                    System.out.println("--------------- OFFSET-------------");
//                    generator.setMediaTime(new Long(options.getOffset()));
                    
                    //apply max duration if present
                    if (options.getDuration() != -1) {
//                        generator.setMaxDuration(new Long(options.getDuration()));
                    }
                } catch (Exception e) {
