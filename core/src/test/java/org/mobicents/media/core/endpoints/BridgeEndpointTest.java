 ...
 * </p>
 * <p>
 * The bridge end point mixes and forwards media between remote and local connections.<br>
 * Media and events arriving to the bridge end point from remote connections are mixed and forwarded to local connections.<br>
 * Respectively, media and events arriving to the bridge end point from local connections are mixed and forwarded to remote
 * connections.
 * </p>
 * 
 * @author yulian oifa
...
public class BridgeEndpointTest extends RTPEnvironment {
    ...
    public void testBridgeBetweenOneRTPAndTwoLocalConnectionsMixOfAudioAndEvents() throws Exception {
        ...
        endpointRTP1.deleteConnection(connectionRTP1);
        endpointLocal1.deleteConnection(connectionEPLocal1);
        endpointLocal2.deleteConnection(connectionEPLocal2);
        bridgeEndpoint.deleteAllConnections();
