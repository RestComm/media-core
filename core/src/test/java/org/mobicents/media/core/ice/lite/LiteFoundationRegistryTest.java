...
public class LiteFoundationRegistryTest {
	...
	public void testFoundationRegistry() {
		...
		HostCandidate candidate1 = new HostCandidate(rtpComponent,
				"192.168.1.65", 61000);
		HostCandidate candidate2 = new HostCandidate(rtpComponent,
				"192.168.1.66", 61001);
		HostCandidate candidate3 = new HostCandidate(rtpComponent,
				"192.168.1.65", 61002);
