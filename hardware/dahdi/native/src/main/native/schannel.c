#include <org_mobicents_media_hardware_dahdi_Channel.h>
#include <org_mobicents_media_hardware_dahdi_Selector.h>
#include <user.h>
#include <errno.h>
#include <stdio.h>
#include <unistd.h>
...
JNIEXPORT void JNICALL Java_org_mobicents_media_hardware_dahdi_Selector_doUnregister (JNIEnv *env, jobject obj, jint fd) {
...
JNIEXPORT void JNICALL Java_org_mobicents_media_hardware_dahdi_Channel_doUnregister (JNIEnv *env, jobject obj, jint fd) {
    struct pollfd temp[480];
...
JNIEXPORT jint JNICALL Java_org_mobicents_media_hardware_dahdi_Selector_doPoll (JNIEnv *env, jobject obj, jintArray selected, jint flags, jint timeout) {
    int res;
