...
public class CompoundSplitterTest {
    ...
    private CompoundComponent analyzer1Component;
    private CompoundComponent analyzer2Component;
    private CompoundComponent analyzer3Component;
    
    private CompoundSplitter splitter;

    public CompoundSplitterTest() {
    }
    ...
    public void setUp() throws IOException {
        ...
        analyzer1Component=new CompoundComponent(2);
        analyzer1Component.addOutput(analyzer1.getCompoundOutput());
        analyzer1Component.updateMode(false,true);
        
        analyzer2Component=new CompoundComponent(3);
        analyzer2Component.addOutput(analyzer2.getCompoundOutput());
        analyzer2Component.updateMode(false,true);
        
        analyzer3Component=new CompoundComponent(4);
        analyzer3Component.addOutput(analyzer3.getCompoundOutput());
        analyzer3Component.updateMode(false,true);
        
        splitter = new CompoundSplitter(scheduler);
