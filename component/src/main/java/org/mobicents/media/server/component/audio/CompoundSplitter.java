...
public class CompoundSplitter {
    ...
    private IntConcurrentLinkedList<CompoundComponent> insideComponents = new IntConcurrentLinkedList();
    private IntConcurrentLinkedList<CompoundComponent> outsideComponents = new IntConcurrentLinkedList();
    ...
    public void addOutsideComponent(CompoundComponent component)
    {
     ...
     * @param component
     */
    public void releaseInsideComponent(CompoundComponent component) {
     ...
     * @param component
     */
    public void releaseOutsideComponent(CompoundComponent component) {
    ...
    private class InsideMixTask extends Task {
        ...
        public long perform() {
            //summarize all
            first=true;
            Iterator<CompoundComponent> activeComponents=insideComponents.iterator();
            while(activeComponents.hasNext())
            {
            	CompoundComponent component=activeComponents.next();
            	component.perform();
    ...
    private class OutsideMixTask extends Task {
        ...
        public long perform() {
            //summarize all
            first=true;
            Iterator<CompoundComponent> activeComponents=outsideComponents.iterator();
            while(activeComponents.hasNext())
            {
            	CompoundComponent component=activeComponents.next();
            	component.perform();
