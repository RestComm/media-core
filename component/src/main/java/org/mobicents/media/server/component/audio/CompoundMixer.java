...
public class CompoundMixer {
    ...
    private IntConcurrentLinkedList<CompoundComponent> components = new IntConcurrentLinkedList();
     ...
     */
    public void release(CompoundComponent component) {
    ...
    private class MixTask extends Task {
        ...
        public long perform() {
        	//summarize all
        	sourcesCount=0;
            Iterator<CompoundComponent> activeComponents=components.iterator();
