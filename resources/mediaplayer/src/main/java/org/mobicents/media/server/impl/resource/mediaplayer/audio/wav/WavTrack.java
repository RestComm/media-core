 ...
 * @author Oifa Yulian
 */
public class WavTrack implements Track {
    ...
    private static final Logger logger = Logger.getLogger(WavTrack.class);
    ...
    public WavTrack(URL url) throws UnsupportedAudioFileException, IOException {
