...
/**
 * InbandGenerator generates Inband DTMF Tone only for uncompressed LINEAR codec. After creating instance of InbandGenerator, it
 * needs to be initialized so that all the Tones are generated and kept ready for transmission once start is called.
 * 
 * By default the Tone duration is 80ms. This is suited for Tone Detector who has Tone duration of greater than 40 and less than
 * 80ms. For Tone Detector who's Tone duration is set greater than 80ms may fail to detect Tone generated by
 * InbandGenerator(with duration 80ms). In that case increase the duration here too.
 * 
 * @author yulian oifa
 * @author amit bhayani
...
public class GeneratorImpl extends AbstractSource implements DtmfGenerator, PooledObject {
    ...
    private static final long serialVersionUID = -7230185585469425056L;
    ...
    private class OOBGenerator extends AbstractSource {
        ...
        private static final long serialVersionUID = 2866397603864864945L;
